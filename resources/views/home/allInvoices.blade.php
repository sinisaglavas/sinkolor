...
<<<<<<< HEAD
                    ...
                    <tr style="background-color: #C8FFC6">
                        ...
                        <td><a href="{{ route('home.supplier_invoices', ['id'=>$invoice->supplier_id]) }}" style="text-decoration: none">{{ \App\Models\Supplier::find($invoice->supplier_id)->supplier }}</a></td>
                        <td><a href="{{ route('home.invoice', ['id'=>$invoice->id]) }}" style="text-decoration: none;">{{ $invoice->invoice_number }}</a></td>
                        ...
                        <td><a href="{{ route('home.editInvoiceData',['id'=>$invoice->id]) }}" class="btn btn-sm btn-warning"
